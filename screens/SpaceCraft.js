...
export default class SpaceCraftsScreen extends Component {
    ...
    getData = () => {
        axios.get("https://11.thespacedevs.com/2.0.0/config/spacecraft/")
        .then(response => {
    ...
    renderItem = ({ item }) => {
        return ( 
            <View style={StyleSheet.contentCard}>
                <Image source={{uri: item.agency.image_url}} style={StyleSheet.itemImage}></Image>
    ...
    if (Object.keys(this.state.aircrafts).length === 0) {
        ...
        return(
            <View style={styles.container}>
                ...
                <ImageBackground source={requestAnimationFrame('../assets/stars.gif')} style={styles.backgroundImage}>
                    <View style={{ flex: 0.15, alingItems: 'center, justifyContent: 'center}}>
...
const styles = StyleSheet.create({
    ...
    droidSafeArea: {
        marginTop: Platform.OS === "android" ? StatusBar.curentHeight : 0
    },
    backgroundImage: {
        flex: 1,
        resizeMode: 'cover',
